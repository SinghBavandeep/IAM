            ...
            <div class="login__form">
                <form action="./index.php?controller=user&action=inscr" method="post" class="login__create" id="login-in">
                    ...
                    <div class="login__box">
                        ...
                        <input type="text" name="name" value="<?php echo $name; ?>" placeholder="Name" class="login__input" required>
                    </div>
                    <div class="login__box">
                        <i class="bx bxs-user login__icon"></i>
                        <input type="text" name="username" value="<?php echo $username; ?>" placeholder="Username" class="login__input" required>
                    </div>
                    <div class="login__box">
                        <i class="bx bx-at login__icon"></i>
                        <input type="email" name="email" value="<?php echo $email; ?>" placeholder="EMail" class="login__input" required>
                    </div>
                    <div class="login__box">
